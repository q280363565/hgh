package cn.edu.nxu.it.generator;
...
public class ModelGenerator {
    ...
    public static void generateModels() {
        ...
        String baseModelOutputDir = PathKit.getRootClassPath() + "/../../../web-app/src/main/java/";
        ...
        // 添加不需要生成的表名
        generator = new Generator(dataSource, new MyBaseModelGenerator(baseModelPackageName, baseModelOutputDir),
                new com.jfinal.plugin.activerecord.generator.ModelGenerator(modelPackageName, baseModelPackageName, modelOutputDir));

        generator.setMetaBuilder(new MyMetaBuilder(dataSource));
